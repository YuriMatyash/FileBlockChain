...
6. Show the connected wallet's PRINT balance/token information. Explain that buyers receive exactly 1 PRINT after each successful marketplace purchase, while the purchase itself still uses ETH.
